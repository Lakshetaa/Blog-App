...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'lakshetaa205@gmail.com', 
        pass: 'cnov zmxk mfaa chzb'
    }
});

mongoose.connect('mongodb+srv://lakshetaa:1234@blogapp.kl6tzf4.mongodb.net/Main_Blog').then(() => console.log('Connected to MongoDB'))
...
BlogSchema.post('save', async function(doc) {
    try {
        ...
        const mailOptions = {
            from: 'lakshetaa205@gmail.com', // Replace with your email
